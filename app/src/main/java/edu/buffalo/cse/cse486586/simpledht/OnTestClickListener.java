...
public class OnTestClickListener implements OnClickListener {
	...
	private class Task extends AsyncTask<Void, String, Void> {
		...
		protected Void doInBackground(Void... params) {
			if (testInsert()) {
               publishProgress("Insert success and my successor:"+SimpleDhtProvider.successor+"My predecessor is:"+SimpleDhtProvider.predecessor);
			} else {
                publishProgress("Insert fail and my successor:"+SimpleDhtProvider.successor+"My predecessor is:"+SimpleDhtProvider.predecessor);
				return null;
			}
